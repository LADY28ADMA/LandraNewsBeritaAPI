...
<body class="bg-gray-50">
    <div class="p-4 mt-4 min-h-dvh">
      <h1 class="text-4xl text-center font-semibold mb-6" id="TIMELINE">Timeline Kontes</h1>
      <div class="container">
        <div class="flex flex-col md:grid grid-cols-12 text-gray-50">
          ...
          <div class="flex md:contents">
            ...
            <div class="bg-green-500 col-start-4 col-end-12 p-4 rounded-xl my-4 mr-auto shadow-md w-full">
              <h3 class="font-semibold text-lg mb-1">Registrasi</h3>
              <p class="leading-tight text-justify w-full">
                16 April - 14 Mei 2024
              </p>
            </div>
          </div>
          ...
          <div class="flex md:contents">
            ...
            <div class="bg-green-500 col-start-4 col-end-12 p-4 rounded-xl my-4 mr-auto shadow-md w-full">
              <h3 class="font-semibold text-lg mb-1">Verifikasi Data</h3>
              <p class="leading-tight text-justify">
                21 April - 14 Mei 2024
              </p>
            </div>
          </div>
          ...
          <div class="flex md:contents">
            ...
            <div class="bg-red-500 col-start-4 col-end-12 p-4 rounded-xl my-4 mr-auto shadow-md w-full">
              <h3 class="font-semibold text-lg mb-1 text-gray-50">Mulai Kontes</h3>
              <p class="leading-tight text-justify">
                1 Mei 2024
              </p>
            </div>
          ...
          <div class="flex md:contents">
            ...
            <div class="bg-gray-300 col-start-4 col-end-12 p-4 rounded-xl my-4 mr-auto shadow-md w-full">
              <h3 class="font-semibold text-lg mb-1 text-gray-400">Selesai</h3>
              <p class="leading-tight text-justify">
